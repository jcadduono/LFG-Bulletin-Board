...
GBB.dungeonTagsLoc={
	enGB = langSplit({
		...
		["DM"]  = 	"deadmines vc vancleef dead mines" ,
		["WC"]  = 	"wc wailing caverns" ,	
		["SFK"] = 	"sfk shadowfang" ,
		["STK"] = 	"stk stock stocks stockade stockades" ,
		["BFD"] = 	"bfd blackfathom" ,
